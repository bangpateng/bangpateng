...
echo -e '\e[1;33m5. Set up firewall\e[0m'
...
echo -e '\e[1;33m6. Install SubQuery\e[0m'
cd $HOME
...
echo -e "Untuk Mengakses Dashboard Buka di Google Chrome Kalian: \e[1;33m$dashboard_url\e[0m"
sleep 2
